...
export default function RegisterOnlyVaccinators(){
    ...
    const [user, setUser] = useState({
        email: '',
        password: process.env.REACT_APP_DEFAULT_VACCINATOR_PASSWORD, //aca deberia haber una funcion random
        name: '',
        birthDate: '',
        LastName: '',
        DNI: '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            emailjs.sendForm(process.env.REACT_APP_EMAILJS_SERVICE_ID, process.env.REACT_APP_EMAILJS_TEMPLATE_REGISTER, form.current, process.env.REACT_APP_EMAILJS_PUBLIC_KEY)
            .then((result) => {
